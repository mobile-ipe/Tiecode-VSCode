...
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpacesItemDecoration(int orientation) {
        this(orientation, 0, 1);
    }

    public SpacesItemDecoration(int orientation, int headerNoShowSize) {
        this(orientation, headerNoShowSize, 1);
    }
    ...
    public SpacesItemDecoration(/*Context context, */int orientation, int headerNoShowSize, int footerNoShowSize) {
        ...
        final TypedArray a = getApplication().obtainStyledAttributes(ATTRS);
    ...
    public SpacesItemDecoration setDrawable(@DrawableRes int id) {
        setDrawable(ContextCompat.getDrawable(getApplication(), id));
        return this;
    }
