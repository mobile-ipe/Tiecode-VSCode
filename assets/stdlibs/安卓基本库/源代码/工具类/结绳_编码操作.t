...
类 编码操作
	...
	*/
	...
	//将文本转换成新的编码格式
	@静态
	方法 转换编码(待转换文本: 文本,原编码: 文本,新编码: 文本): 文本
		@code
		if (#待转换文本 == null) {
			return "";
		}
	...
	@静态
	方法 文本到二进制(内容 : 文本, 编码 : 文本 = "UTF-8") : 文本
		@code
		String content = #内容;
		if (content == null || content.isEmpty()) return null;
		try {
	...
	@静态
	方法 文本到十六进制(内容 : 文本, 编码 : 文本 = "UTF-8") : 文本
		@code
		String content = #内容;
		if (content == null || content.isEmpty()) return null;
		try {
	...
	@静态
	方法 十六进制到文本(内容 : 文本, 编码 : 文本 = "UTF-8") : 文本
		@code
		String content = #内容;
		if (content == null || content.isEmpty()) return null;
		try {
